...
<template>
    <div class="bg-black text-white p-3 w-100" style="position: absolute; top: 0px;">
    ...
    <div className="container-fluid">
        <div className="row">
            ...
            <main className="col-md-9 ms-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container mt-5" style="width: 1230px;">
                    <h2>Đăng nhập</h2>

                    <div className="mb-3">
                        <label className="form-label">Email</label>
                        <input type="email" className="form-control" v-model="model.user.email" placeholder="Nhập email"
                            required />
                    </div>
                    <div className="mb-3">
                        <label className="form-label">Mật khẩu</label>
                        <input type="text" className="form-control" v-model="model.user.password"
